...
set CA_DEVEL_RESDIR=devel_msys2\share\codeadapt
set CA_OUTPUT_RESDIR=output_msys2\share\codeadapt

if not exist output_msys2 md output_msys2\
if not exist output_msys2\share md output_msys2\share\
...
if not exist devel_msys2 md devel_msys2\
if not exist devel_msys2\share md devel_msys2\share\
...
copy /y devel_msys2\*.exe output_msys2 > nul
copy /y devel_msys2\*.dll output_msys2 > nul
