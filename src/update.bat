...
set CA_DEVEL_RESDIR=devel\share\codeadapt
set CA_OUTPUT_RESDIR=output\share\codeadapt
...
if not exist %CA_OUTPUT_RESDIR%\images\codecompletion md %CA_OUTPUT_RESDIR%\images\codecompletion\
...
if not exist %CA_DEVEL_RESDIR%\images\codecompletion md %CA_DEVEL_RESDIR%\images\codecompletion\
...
%ZIPCMD% -j9 %CA_DEVEL_RESDIR%\codecompletion.zip plugins\codecompletion\resources\manifest.xml plugins\codecompletion\resources\*.xrc > nul
%ZIPCMD% -j9 %CA_DEVEL_RESDIR%\compiler.zip plugins\compilergcc\resources\manifest.xml plugins\compilergcc\resources\*.xrc > nul
%ZIPCMD% -j9 %CA_DEVEL_RESDIR%\debugger.zip plugins\debuggergdb\resources\manifest.xml plugins\debuggergdb\resources\*.xrc > nul
...
%ZIPCMD% -0 -q ..\..\..\%CA_DEVEL_RESDIR%\debugger.zip images\*.png images\16x16\*.png > nul
cd ..\..\..
...
copy /y plugins\codecompletion\resources\images\*.png %CA_DEVEL_RESDIR%\images\codecompletion > nul
copy /y plugins\codecompletion\resources\images\*.png %CA_OUTPUT_RESDIR%\images\codecompletion > nul
...
xcopy /y templates\common\* %CA_OUTPUT_RESDIR%\templates /EXCLUDE:excludes.txt > nul
xcopy /y templates\win32\* %CA_OUTPUT_RESDIR%\templates /EXCLUDE:excludes.txt > nul
xcopy /y templates\common\* %CA_DEVEL_RESDIR%\templates /EXCLUDE:excludes.txt > nul
xcopy /y templates\win32\* %CA_DEVEL_RESDIR%\templates /EXCLUDE:excludes.txt > nul
...
strip output\*.exe
strip output\*.dll
strip %CA_OUTPUT_RESDIR%\plugins\*.dll
