...
rem ------------------------------------------
if not defined GCC_ROOT set GCC_ROOT=C:\Apps32\MingwGCC471TDM
...
if not defined CB_PARAMS set CB_PARAMS=-p gcc471TDM --batch-build-notify --no-batch-window-close
set CB_CMD=%BUILD_TYPE% "%~dp0codeAdapt_testBatch_wx30-win32.cbp"
