 ...
 *
 * $Revision: 10543 $
 * $Id: compilerpanel.cpp 10543 2015-10-21 05:52:42Z mortenmacfly $
 * $HeadURL: http://svn.code.sf.net/p/codeblocks/code/branches/release-16.xx/src/plugins/scriptedwizard/compilerpanel.cpp $
 */
    ...
    m_parentDialog(parentDialog)
{
	...
	StaticText1 = new wxStaticText(this, ID_STATICTEXT1, _("Please select the compiler to use and which configurations\nyou want enabled in your project."), wxDefaultPosition, wxDefaultSize, 0, wxT_2("ID_STATICTEXT1"));
	BoxSizer1->Add(StaticText1, 0, wxALL|wxEXPAND, 8);
	StaticText2 = new wxStaticText(this, ID_STATICTEXT2, _("Compiler:"), wxDefaultPosition, wxDefaultSize, 0, wxT_2("ID_STATICTEXT2"));
	BoxSizer1->Add(StaticText2, 0, wxTOP|wxLEFT|wxRIGHT|wxEXPAND, 8);
	cmbCompiler = new wxComboBox(this, ID_COMBOBOX1, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, wxCB_SIMPLE|wxCB_READONLY, wxDefaultValidator, wxT_2("ID_COMBOBOX1"));
	BoxSizer1->Add(cmbCompiler, 0, wxBOTTOM|wxLEFT|wxRIGHT|wxEXPAND, 8);
	BoxSizer4 = new wxBoxSizer(wxHORIZONTAL);
	chkConfDebug = new wxCheckBox(this, ID_CHECKBOX1, _("Create \"Debug\" configuration:"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, wxT_2("ID_CHECKBOX1"));
	chkConfDebug->SetValue(true);
	BoxSizer4->Add(chkConfDebug, 0, wxALIGN_CENTER_VERTICAL, 5);
	txtDbgName = new wxTextCtrl(this, ID_TEXTCTRL3, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, wxT_2("ID_TEXTCTRL3"));
	...
	StaticText3 = new wxStaticText(this, ID_STATICTEXT3, _("Output dir.:"), wxDefaultPosition, wxDefaultSize, 0, wxT_2("ID_STATICTEXT3"));
	FlexGridSizer1->Add(StaticText3, 1, wxALIGN_CENTER_VERTICAL, 5);
	txtDbgOut = new wxTextCtrl(this, ID_TEXTCTRL1, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, wxT_2("ID_TEXTCTRL1"));
	FlexGridSizer1->Add(txtDbgOut, 1, wxEXPAND, 5);
	StaticText4 = new wxStaticText(this, ID_STATICTEXT4, _("Objects output dir.:"), wxDefaultPosition, wxDefaultSize, 0, wxT_2("ID_STATICTEXT4"));
	FlexGridSizer1->Add(StaticText4, 1, wxALIGN_CENTER_VERTICAL, 5);
	txtDbgObjOut = new wxTextCtrl(this, ID_TEXTCTRL2, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, wxT_2("ID_TEXTCTRL2"));
	...
	chkConfRelease = new wxCheckBox(this, ID_CHECKBOX3, _("Create \"Release\" configuration:"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, wxT_2("ID_CHECKBOX3"));
	chkConfRelease->SetValue(true);
	BoxSizer5->Add(chkConfRelease, 0, wxALIGN_CENTER_VERTICAL, 5);
	txtRelName = new wxTextCtrl(this, ID_TEXTCTRL4, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, wxT_2("ID_TEXTCTRL4"));
	...
	StaticText7 = new wxStaticText(this, ID_STATICTEXT7, _("Output dir.:"), wxDefaultPosition, wxDefaultSize, 0, wxT_2("ID_STATICTEXT7"));
	FlexGridSizer2->Add(StaticText7, 1, wxALIGN_CENTER_VERTICAL, 5);
	txtRelOut = new wxTextCtrl(this, ID_TEXTCTRL5, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, wxT_2("ID_TEXTCTRL5"));
	FlexGridSizer2->Add(txtRelOut, 1, wxEXPAND, 5);
	StaticText8 = new wxStaticText(this, ID_STATICTEXT8, _("Objects output dir.:"), wxDefaultPosition, wxDefaultSize, 0, wxT_2("ID_STATICTEXT8"));
	FlexGridSizer2->Add(StaticText8, 1, wxALIGN_CENTER_VERTICAL, 5);
	txtRelObjOut = new wxTextCtrl(this, ID_TEXTCTRL6, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, wxT_2("ID_TEXTCTRL6"));
