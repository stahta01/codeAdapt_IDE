...
{
  wxString GroupName = ::caGetTextFromUser(_("Enter name for new group"));
...
void Configuration::OnRenameGroup(wxCommandEvent& /*event*/)
{
  ...
  GroupName = ::caGetTextFromUser(_("Enter new group name"),_("Change group name"),GroupName);
  if ( GroupName.IsEmpty() )
    return;
...
{
  wxString Identifier = ::caGetTextFromUser(_("Enter new identifier"));
...
void Configuration::OnChangeIdentifier(wxCommandEvent& /*event*/)
{
  ...
  Identifier = ::caGetTextFromUser(_("Enter new identifier"),_("Change identifier"),Identifier);
  if ( Identifier.IsEmpty() )
    return;
