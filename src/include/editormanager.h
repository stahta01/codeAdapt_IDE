...
class DLLIMPORT EditorManager : public Mgr<EditorManager>, public wxEvtHandler
{
    ...
    public:
        ...
        EditorManager(const EditorManager& rhs) { cbThrow(wxT_2("Can't call EditorManager's copy ctor!!!")); }
        virtual void operator=(const EditorManager& rhs){ cbThrow(wxT_2("Can't assign an EditorManager* !!!")); }
