...
const char* s_cbScriptPlugin =
    ...
    "    constructor()\n"
    "    {\n"
    "        info.name = wxT_2(\"cbScriptPlugin\");\n"
    "        info.title = wxT_2(\"Base script plugin\");\n"
    "        info.version = wxT_2(\"0.1a\");\n"
    "        info.license = wxT_2(\"GPL\");\n"
    "    }\n"
    ...
    "    function Execute()\n"
    "    {\n"
    "        LogDebug(info.name + wxT_2(\"::Run() : not implemented\"));\n"
    "        return -1;\n"
    "    }\n"
    "    function OnMenuClicked(index)\n"
    "    {\n"
    "        LogDebug(info.name + wxT_2(\": menu clicked: \") + index);\n"
    "    }\n"
    "    function OnModuleMenuClicked(index)\n"
    "    {\n"
    "        LogDebug(info.name + wxT_2(\": module menu clicked: \") + index);\n"
    "    }\n"
    "}\n";
