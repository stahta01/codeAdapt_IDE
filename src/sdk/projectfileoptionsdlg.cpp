...
{
    wxXmlResource::Get()->LoadDialog(this, parent, wxT_2("dlgProjectFileOptions"));
    ...
    if (pf)
    {
        ...
        XRCCTRL(*this, "txtProject", wxTextCtrl)->SetValue(prj?(prj->GetTitle() + wxT_2("\n") + prj->GetFilename()):wxT_2("-"));
...
void ProjectFileOptionsDlg::FillGeneralProperties(const wxString& fileName)
{
    ...
    langCPP.ext.Add(wxT_2("c"));
    langCPP.ext.Add(wxT_2("cc"));
    langCPP.ext.Add(wxT_2("cxx"));
    langCPP.ext.Add(wxT_2("cpp"));
    langCPP.ext.Add(wxT_2("h"));
    langCPP.ext.Add(wxT_2("hpp"));
    langCPP.single_line_comment = wxT_2("//");
    langCPP.multiple_line_comment[0] = wxT_2("/*");
    langCPP.multiple_line_comment[1] = wxT_2("*/");
...
void ProjectFileOptionsDlg::EndModal(int retCode)
{
    ...
    //  m_ProjectFile->SetObjName(XRCCTRL(*this, "txtObjName", wxTextCtrl)->GetValue());
        ...
        if (m_ProjectFile->compile && m_ProjectFile->compilerVar.IsEmpty())
            m_ProjectFile->compilerVar = wxT_2("CPP");
